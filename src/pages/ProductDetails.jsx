  ...
  return (
    <>
      <div className="container mx-auto px-4 md:px-8 bg-gray-900 min-h-screen rounded-2xl shadow-2xl my-8 p-6 md:p-12 border border-gray-800">
        <Link to={"/"}>
          <button className="cursor-pointer flex items-center text-gray-400 hover:text-sky-400 transition duration-150 mb-12 font-semibold text-lg">
          ...
          <div className="flex flex-col justify-between">
            ...
            <div className="mt-5 space-y-4 flex justify-center items-center flex-col">
              <button
                ...
                className="w-full py-3 bg-sky-600 text-white font-bold rounded-full shadow-lg shadow-orange-800/50 cursor-pointer hover:bg-orange-700 transition duration-300 flex items-center justify-center space-x-2 transform hover:ring-4 hover:ring-pink-600/50 uppercase tracking-wider"
              >
              ...
              <Link
                to={"/"}
                className="w-full py-3 border-2 border-sky-600 text-sky-400 font-bold rounded-full cursor-pointer hover:bg-orange-900/50 transition duration-300 uppercase tracking-wider text-center"
              >
                Keep Shopping
              </Link>
            </div>
