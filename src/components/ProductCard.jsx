    ...
    <>
      <div className="bg-gray-900 rounded-2xl shadow-xl overflow-hidden flex flex-col h-full transition duration-500 transform border border-gray-800 group hover:scale-[1.03] hover:shadow-orange-900/40">
        ...
        >
          ...
          />
          <div className="absolute bottom-0 left-0 bg-sky-600/95 text-white px-5 py-2 text-xl font-extrabold rounded-tr-xl shadow-lg">
        ...
        <div className="p-5 flex flex-col grow">
          ...
          onClick={()=>addToCart(product)}
           className="max-auto w-full py-3 bg-sky-600 text-white font-bold rounded-full shadow-lg shadow-orange-800/50 cursor-pointer hover:bg-orange-700 transition duration-300 flex items-center justify-center space-x-2 transform hover:ring-4 hover:ring-pink-600/50 uppercase tracking-wider">
